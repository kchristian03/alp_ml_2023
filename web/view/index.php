...
<body class="pt-8">
    <div class="max-w-md mx-auto bg-indigo-200 p-8 rounded-md shadow-md">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="mb-4">
                <label for="avg_glucose_level" class="block text-sm font-medium text-gray-600">Average Glucose Level:</label>
                <input type="number" id="avg_glucose_level" name="avg_glucose_level" class="mt-1 p-2 w-full border rounded-md" step="any">
            </div>
            ...
            <div>
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 mt-3 rounded-md">Submit</button>
            </div>
        </form>
    </div>
</body>
